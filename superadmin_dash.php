    ...
    <main class="main-content">
        <header class="sa-main-header">
            ...
            <div class="sa-profile">
                <div id="globalNotificationBell" style="position:relative; cursor:pointer; width:36px; height:36px; border-radius:50%; background:#e2e8f0; display:flex; align-items:center; justify-content:center; box-shadow:0 2px 5px rgba(0,0,0,0.05); transition:all 0.2s ease; margin-right: 8px;" onmouseover="this.style.background='white';this.style.boxShadow='0 4px 10px rgba(0,0,0,0.1)'" onmouseout="this.style.background='#e2e8f0';this.style.boxShadow='0 2px 5px rgba(0,0,0,0.05)'" onclick="if(typeof toggleNotificationSidebar === 'function') toggleNotificationSidebar();">
