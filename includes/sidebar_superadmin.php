  ...
  <div class="sidebar-header">
    <div class="sidebar-logo">
      <div class="sidebar-logo-icon">
        ...
        if ($logoPath !== '') {
            ...
            if (file_exists($localPath)) {
                $logoHtml = '<img src="' . htmlspecialchars($logoPath, ENT_QUOTES, 'UTF-8') . '?t=' . time() . '" alt="Logo" style="width:100%;height:100%;object-fit:contain;border-radius:4px;">';
            }
        }
        echo $logoHtml;
        ?>
      ...
      <div>
        ...
        <div style="font-size:11px;color:rgba(255,255,255,0.95);font-weight:500;margin-top:2px">
          @<?php echo htmlspecialchars($_SESSION['superadmin_username'] ?? 'admin', ENT_QUOTES, 'UTF-8'); ?>
        </div>
      </div>
    </div>
  </div>
